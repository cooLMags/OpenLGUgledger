...
/**
 * This is the model class for table "trial_monthly".
 *
 * The followings are the available columns in table 'trial_monthly':
 ...
 */
class TrialMonthly extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TrialMonthly the static model class
	 */
